...
############# USER PARAMETERS ########
RETAG = False
LocalCalibSuffix = "WHATEVER"
#####################################
print 'FLS: subjob number MYID'
### Define input xAOD and output ntuple file name
import glob
from AthenaCommon.AthenaCommonFlags import jobproperties as jp
jp.AthenaCommonFlags.SkipEvents.set_Value_and_Lock( 0 )
jp.AthenaCommonFlags.EvtMax.set_Value_and_Lock( vars().get('EVTMAX', 20) )
...
jp.AthenaCommonFlags.FilesInput = [ 
    ...
    #"/scratch/data/srm/atlaslocalgroupdisk/rucio/mc15_13TeV/ba/4e/AOD.07915862._000002.pool.root.1"
    #"/scratch/users/flosterzo/datasets/mc16_13TeV.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.merge.AOD.e3698_s2997_r8903_r8906/AOD.10226638._000111.pool.root.1"
    "/users/cmilke/scratch/authorship/datasets/ttbar_aod_samples/mc16_13TeV.410000.PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_nonallhad.recon.AOD.e5603_s3126_d1472_d1471_r10516_tid14330755_00/AOD.14330755._000011.pool.root.1"
    ]
...
#svcMgr.THistSvc.Output += ["TriggerJets DATAFILE='flavnutple_test_base.root' OPT='RECREATE'"]
#svcMgr.THistSvc.Output += ["RefFile DATAFILE='reffile_test_base.root' OPT='RECREATE'"]
svcMgr.THistSvc.Output += ["TriggerJets DATAFILE='manual_tests/flavnutple01.root' OPT='RECREATE'"]
svcMgr.THistSvc.Output += ["RefFile DATAFILE='manual_tests/reffile01.root' OPT='RECREATE'"]
...
### For FTK
alg1.TriggerName = "HLT_j35_boffperf_split_FTK_L1J15_FTK"
#alg1.Trig_JetKey = "SplitJet"
alg1.Trig_PriVtxKey = "PrimVertexFTK"  # Primary vertices are not attached to the trigger navigation yet. Should be solved by 21.0.18
